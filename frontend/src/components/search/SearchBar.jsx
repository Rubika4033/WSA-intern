...
const SearchBar = ({ setSearchSongs }) => { // <-- destructured props
    ...
    const fetchSongs = async () => {
      try {
        ...
        const res = await axios.get(
          `${import.meta.env.VITE_BASE_URL}/api/song/playListByTag/${encodeURIComponent(query)}`
        );
  ...
  return (
    <div className="searchbar-root">
      ...
      {!query && !loading && <p className="searchbar-empty">Search song to display</p>}
